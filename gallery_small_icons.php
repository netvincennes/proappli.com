...
$dossier = "_resources/small_icons/";
...
<title>Gallery small icons</title>
<style type="text/css">
div.img
{
margin:2px;
...
//window.parent.iconselect(url);
window.close();
window.opener.iconselect(url); 
}
</script>
</head>
<body>
...
//      echo "<img src='$dir_and_file' width='$width' height='$height' /></a>";
      echo "<img src='$dir_and_file' width='$height' height='$height' /></a>";
